...
var lp_noLPErr = "Nenhum problema de Linear fornecido";
var lp_IllegCharsErr = "Caracteres ilegais";
var lp_UnspecMaxMinErr = "Máximo ou mínimo não especificado";
var lp_noRelationConstrErr = "As restrições devem conter '=', '<=', or '>='";
var lo_tooManyTabloeausErr = "O número de tablaturas excede ";
var lp_emptyFeasibleRegionErr = "Sem solução; Região viável vazia";
var lp_noMaxErr = "Sem valor máximo; a função objetivo pode ser arbitrariamente grande";
var lp_noMinErr = "Sem valor mínimo; a função objetivo pode ser arbitrariamente grande, negativa";
var lp_phase2TooSoonErr = "Tentativa de realizar a Fase 2 quando a Fase 1 não estiver concluída.";
var lp_badExprErr = "Algo está errado na expressão";
var lp_illegalCoeffErr = "coeficiente ilegal de ";
var lp_inExprErr = " na expressão\n";
var lp_objNotSetErr = "Objetivo não definido na extração";
var lp_noNiceSolutionErr = "Nenhuma solução com os valores inteiros desejados existe"
